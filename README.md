...
// Configuration options
{
    ...
    "iio_channels" : [
         {
        // режим работы драйвера однопоточный, данное значение указывает сколько раз считать 
        // значение в данном канале за один проход, по умолчанию 10
                "readings_number" : 10,
